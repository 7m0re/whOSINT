...
sudo mv $HOME/whOSINT/media/wallpaper/* /usr/share/backgrounds/whOSINT/
...
sudo sqlite3 ~/.mozilla/firefox/*.default-esr/places.sqlite ".restore $HOME/whOSINT/bookmarks/OSINTbookmarks.backup"	
sudo sqlite3 ~/.tb/tor-browser/Browser/TorBrowser/Data/Browser/profile.default/places.sqlite ".restore $HOME/whOSINT/bookmarks/OSINTbookmarks.backup"